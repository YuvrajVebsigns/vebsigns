export const developerTabs = [
  {
    ...
    title: "Hire Dedicated Flutter App Developer",
    description:
      "Get in touch with our expert Flutter developers to build high-performance applications.",
    image: "/assets/HomePage/HirePage.jpeg",
    features: [
      {
        title: "Fast Development",
        description:
          "Flutter's hot reload feature allows for quick iterations and real-time updates.",
        image: "/assets/hire page/1 flutter/Fast Development.svg",
      },
      {
        title: "Beautiful UI",
        description:
          "Flutter provides a rich set of pre-designed widgets for a beautiful app experience.",
        image: "/assets/hire page/1 flutter/Beautiful UI.svg",
      },
      {
        title: "Cross-Platform",
        description:
          "Build applications for both iOS and Android from a single codebase.",
        image: "/assets/hire page/1 flutter/Cross-Platform.svg",
      },
    ],
    benefits: [
      {
  ...
  },
  {
    ...
    title: "Hire Skilled Android App Developers",
    description:
      "Our team of talented Android developers at Vebsigns! is dedicated to bringing your vision to life on the Google Play Store.",
    image: "/assets/HomePage/HirePage.jpeg",
    features: [
      {
        title: "UI/UX Design Expertise",
        description:
          "Our developers excel in creating intuitive and visually appealing user interfaces, enhancing the user experience and driving engagement.",
        image: "/assets/hire page/2 android/UIUX Design Expertise.svg",
      },
      {
        title: "Proficiency with Latest Technologies",
        description:
          "They stay abreast of the latest trends and technologies in Android app development, ensuring that your app is built using the most advanced tools and techniques.",
        image:
          "/assets/hire page/2 android/Proficiency with Latest Technologies.svg",
      },
      {
        title: "Extensive Experience",
        description:
          "Our Android app developers boast years of experience in the field, having worked on diverse projects across various industries.",
        image: "/assets/hire page/2 android/Extensive Experience.svg",
      },
      {
        ...
        image: "/assets/hire page/2 android/Custom design Solutions.svg",
      },
      {
        title: "Timely Delivery",
        description:
          "They are committed to delivering projects on time and within budget, without compromising on quality. Their efficient project management skills ensure smooth and timely project delivery.",
        image: "/assets/hire page/2 android/timely delivery.svg",
      },
      {
        title: "Post-Launch Support",
        description:
          "They provide ongoing support and maintenance services to ensure that your app remains up-to-date, secure, and optimized for performance even after its launch.",
        image: "/assets/hire page/2 android/post launch support.svg",
      },
    ],
    benefits: [
      {
    ...
    features: [
      {
        ...
        image: "/assets/hire page/3 ios/API development and Integration.svg",
      },
      {
        ...
        image: "/assets/hire page/3 ios/Testing and Debugging.svg",
      },
      {
        ...
        image: "/assets/hire page/3 ios/iOS Development.svg",
      },
      {
        title: "Custom Solutions",
        description:
          "They have a knack for crafting custom solutions tailored to meet your specific business requirements and goals, ensuring that your app stands out in the crowded marketplace.",
        image: "/assets/hire page/3 ios/Custom design Solutions.svg",
      },
      {
        title: "UI/UX Design Expertise",
        description:
        ...
        image: "/assets/hire page/3 ios/UIUX Design Expertise.svg",
      },
    ],
    benefits: [
      {
    ...
    features: [
      {
        ...
        image: "/assets/hire page/4 php/Advanced PHP Frameworks.svg",
      },
      {
        ...
        image: "/assets/hire page/4 php/Frontend Technologies.svg",
      },
      {
        ...
        image: "/assets/hire page/4 php/Custom design Solutions.svg",
      },
      {
        ...
        image: "/assets/hire page/4 php/Database Management.svg",
      },
      {
        ...
        image: "/assets/hire page/4 php/API development and Integration.svg",
      },
      {
        ...
        image: "/assets/hire page/4 php/Scalable and Secure Solutions.svg",
      },
    ],
    benefits: [
      {
    ...
    features: [
      {
        ...
        image:
          "/assets/hire page/5 java developer/Scalable and Secure Solutions.svg",
      },
      {
        title: "Frontend Technologies",
        description:
          "While primarily focused on backend development, our PHP developers also have a good understanding of frontend technologies such as HTML, CSS, JavaScript, and JavaScript frameworks like React.js and Vue.js. This enables them to collaborate effectively with frontend developers and create seamless user experiences in web applications.",
        image: "/assets/hire page/5 java developer/Frontend Technologies.svg",
      },
      {
        title: "Customized Solutions",
        description:
          "Our Java developers have experience developing custom solutions tailored to meet the specific requirements and objectives of each project. Whether it’s building a content management system (CMS), an e-commerce platform, a customer relationship management (CRM) system, or any other web application, our developers have the skills and expertise to deliver bespoke solutions that address your unique needs.",
        image: "/assets/hire page/5 java developer/Custom design Solutions.svg",
      },
      {
        title: "Database Management",
        description:
          "Our developers are proficient in database management systems such as MySQL, PostgreSQL, MongoDB, and SQLite. They have experience in designing and optimizing databases, implementing complex queries, and ensuring data integrity and security within web applications.",
        image: "/assets/hire page/5 java developer/Database Management.svg",
      },
      {
        title: "API Development and Integration",
        description:
        ...
        image:
          "/assets/hire page/5 java developer/API development and Integration.svg",
      },
      {
        title: "Scalable and Secure Solutions",
        description:
    ...
    features: [
      {
        ...
        image:
          "/assets/hire page/6 python developer/Advanced Python Frameworks.svg",
      },
      {
        title: "Frontend Technologies",
        description:
          "While primarily focused on backend development, our PHP developers also have a good understanding of frontend technologies such as HTML, CSS, JavaScript, and JavaScript frameworks like React.js and Vue.js. This enables them to collaborate effectively with frontend developers and create seamless user experiences in web applications.",
        image: "/assets/hire page/6 python developer/Frontend Technologies.svg",
      },
      {
        title: "Customized Solutions",
        description:
        ...
        image:
          "/assets/hire page/6 python developer/Custom design Solutions.svg",
      },
      {
        title: "Database Management",
        description:
          "Our developers are proficient in database management systems such as MySQL, PostgreSQL, MongoDB, and SQLite. They have experience in designing and optimizing databases, implementing complex queries, and ensuring data integrity and security within web applications.",
        image: "/assets/hire page/6 python developer/Database Management.svg",
      },
      {
        title: "API Development and Integration",
        description:
        ...
        image:
          "/assets/hire page/6 python developer/API development and Integration.svg",
      },
      {
        title: "Scalable and Secure Solutions",
        description:
        ...
        image:
          "/assets/hire page/6 python developer/Scalable and Secure Solutions.svg",
      },
    ],
    benefits: [
      {
    ...
    features: [
      {
        ...
        description:
          "While primarily focused on backend development, our PHP developers also have a good understanding of frontend technologies such as HTML, CSS, JavaScript, and JavaScript frameworks like React.js and Vue.js. This enables them to collaborate effectively with frontend developers and create seamless user experiences in web applications.",
        image: "/assets/hire page/7 react js/Frontend Technologies.svg",
      },
      {
        title: "Customized Solutions",
        description:
          "Our ReactJS developers have experience developing custom solutions tailored to meet the specific requirements and objectives of each project. Whether it’s building a content management system (CMS), an e-commerce platform, a customer relationship management (CRM) system, or any other web application, our developers have the skills and expertise to deliver bespoke solutions that address your unique needs.",
        image: "/assets/hire page/7 react js/Custom design Solutions.svg",
      },
      {
        title: "Database Management",
        description:
          "Our developers are proficient in database management systems such as MySQL, PostgreSQL, MongoDB, and SQLite. They have experience in designing and optimizing databases, implementing complex queries, and ensuring data integrity and security within web applications.",
        image: "/assets/hire page/7 react js/Database Management.svg",
      },
      {
        title: "Scalable and Secure Solutions",
        description:
          "Our Python developers prioritize scalability and security in their development approach. They follow best practices for coding, implement secure authentication and authorization mechanisms, and employ encryption techniques to safeguard sensitive data. Additionally, they design web applications with scalability in mind, ensuring that they can handle increased traffic and user loads as your business grows.",
        image: "/assets/hire page/7 react js/Scalable and Secure Solutions.svg",
      },
    ],
    benefits: [
      {
    ...
    features: [
      {
        ...
        image: "/assets/hire page/8 node js/Advanced Node.js Frameworks.svg",
      },
      {
        title: "Frontend Technologies",
        description:
          "While primarily focused on backend development, our Node Js developers also have a good understanding of frontend technologies such as HTML, CSS, JavaScript, and JavaScript frameworks like React.js and Vue.js. This enables them to collaborate effectively with frontend developers and create seamless user experiences in web applications.",
        image: "/assets/hire page/8 node js/Frontend Technologies.svg",
      },
      {
        title: "Database Management",
        description:
          "Our developers are proficient in database management systems such as MySQL, PostgreSQL, MongoDB, and SQLite. They have experience in designing and optimizing databases, implementing complex queries, and ensuring data integrity and security within web applications.",
        image: "/assets/hire page/8 node js/Database Management.svg",
      },
      {
        title: "Customized Solutions",
        description:
          "Our Node Js developers have experience developing custom solutions tailored to meet the specific requirements and objectives of each project. Whether it’s building a content management system (CMS), an e-commerce platform, a customer relationship management (CRM) system, or any other web application, our developers have the skills and expertise to deliver bespoke solutions that address your unique needs.",
        image: "/assets/hire page/8 node js/Custom design Solutions.svg",
      },
      {
        title: "API Development and Integration",
        description:
        ...
        image:
          "/assets/hire page/8 node js/API development and Integration.svg",
      },
      {
        title: "Scalable and Secure Solutions",
        description:
          "Our Python developers prioritize scalability and security in their development approach. They follow best practices for coding, implement secure authentication and authorization mechanisms, and employ encryption techniques to safeguard sensitive data. Additionally, they design web applications with scalability in mind, ensuring that they can handle increased traffic and user loads as your business grows.",
        image: "/assets/hire page/8 node js/Scalable and Secure Solutions.svg",
      },
    ],
    benefits: [
      {
    ...
    features: [
      {
        ...
        image: "/assets/hire page/9 next js/Frontend Technologies.svg",
      },
      {
        title: "Customized Solutions",
        description:
          "Our NextJS developers have experience developing custom solutions tailored to meet the specific requirements and objectives of each project. Whether it’s building a content management system (CMS), an e-commerce platform, a customer relationship management (CRM) system, or any other web application, our developers have the skills and expertise to deliver bespoke solutions that address your unique needs.",
        image: "/assets/hire page/9 next js/Custom design Solutions.svg",
      },
      {
        title: "Database Management",
        description:
          "Our developers are proficient in database management systems such as MySQL, PostgreSQL, MongoDB, and SQLite. They have experience in designing and optimizing databases, implementing complex queries, and ensuring data integrity and security within web applications.",
        image: "/assets/hire page/9 next js/Database Management.svg",
      },
      {
        title: "Scalable and Secure Solutions",
        description:
        ...
        image: "/assets/hire page/9 next js/Scalable and Secure Solutions.svg",
      },
    ],
    benefits: [
      {
    ...
    features: [
      {
        ...
        image:
          "/assets/hire page/10 anguler js/Proficiency in Angular Framework.svg",
      },
      {
        ...
        image:
          "/assets/hire page/10 anguler js/Custom Application Development.svg",
      },
      {
        ...
        image:
          "/assets/hire page/10 anguler js/API development and Integration.svg",
      },
      {
        ...
        image:
          "/assets/hire page/10 anguler js/Scalability & Performance Optimization.svg",
      },
      {
        ...
        image:
          "/assets/hire page/10 anguler js/Cross-Browser & Responsive Applications.svg",
      },
      {
        ...
        image: "/assets/hire page/10 anguler js/Maintenance & Support.svg",
      },
    ],
    benefits: [
      {
    ...
    features: [
      {
        ...
        image: "/assets/hire page/11 QA/Expertise in Testing Frameworks.svg",
      },
      {
        ...
        image: "/assets/hire page/11 QA/Custom Test Strategies.svg",
      },
      {
        ...
        image: "/assets/hire page/11 QA/API development and Integration.svg",
      },
      {
        ...
        image: "/assets/hire page/11 QA/Performance & Load Testing.svg",
      },
      {
        ...
        image: "/assets/hire page/11 QA/Cross-Platform.svg",
      },
      {
        ...
        image: "/assets/hire page/11 QA/Maintenance & Support.svg",
      },
    ],
    benefits: [
      {
    ...
    features: [
      {
        ...
        image: "/assets/hire page/12 UI UX/User-Centered Design.svg",
      },
      {
        ...
        image: "/assets/hire page/12 UI UX/Custom design Solutions.svg",
      },
      {
        ...
        image: "/assets/hire page/12 UI UX/Interactive Prototypin.svg",
      },
      {
        ...
        image:
          "/assets/hire page/12 UI UX/Responsive & Adaptive Interfaces.svg",
      },
      {
        ...
        image: "/assets/hire page/12 UI UX/Brand Consistency.svg",
      },
      {
        ...
        image: "/assets/hire page/12 UI UX/Maintenance & Support.svg",
      },
    ],
    benefits: [
      {
