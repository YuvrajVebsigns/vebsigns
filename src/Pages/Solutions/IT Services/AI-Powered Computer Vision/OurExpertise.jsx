    ...
    <section className="bg-gradient-to-b from-white to-blue-50 px-4 sm:px-6 md:px-8">
      <div className="max-w-auto mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
        ...
        <div className="mt-8 md:mt-0">
          ...
          <img
            src="/assets/HomePage/clapping.svg"
            alt=""
            className="w-12 h-12 md:w-16 md:h-16"
          />

          <h3 className="font-extrabold uppercase mt-4 text-2xl sm:text-3xl md:text-6xl text-[#15042E]">
            Core Features of AI-Powered Computer Vision
          </h3>

          <p className="mt-3 text-sm sm:text-base md:text-lg text-gray-700">
            Our computer vision solutions enable machines to understand and
            interpret visual data with high accuracy. Key features include
            Object Detection, Image Classification, Video Analytics, Facial
            Recognition, Quality Inspection, and Real-Time Visual Monitoring.
          </p>
