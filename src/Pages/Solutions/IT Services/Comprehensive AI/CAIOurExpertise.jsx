    ...
    return (
       ...
       <img src="/assets/HomePage/clapping.svg" alt="" className="w-12 h-12 md:w-16 md:h-16" />
                        ...
                        <p className="mt-3 text-sm sm:text-base md:text-lg text-gray-700">
                            Our ecosystem solutions unify data, intelligence, and technology. Key features include Data Integration, Model Lifecycle Management, Intelligent Automation, and Scalable Deployments.
...
export default CAIOurExpertise
