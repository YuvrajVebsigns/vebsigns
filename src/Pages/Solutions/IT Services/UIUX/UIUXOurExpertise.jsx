    ...
    return (
       ...
       <img src="/assets/HomePage/clapping.svg" alt="" className="w-12 h-12 md:w-16 md:h-16" />
                        ...
                        <p className="mt-3 text-sm sm:text-base md:text-lg text-gray-700">
                            Comprehensive UX services including strategy & research, product & experience design, conversion optimization, AI-driven solutions, and enterprise & startup support.
                        </p>
...
export default UIUXOurExpertise
