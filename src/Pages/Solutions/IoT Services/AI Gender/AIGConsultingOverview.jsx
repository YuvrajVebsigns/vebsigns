                ...
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-1 md:order-1 w-full">
                        ...
                        <h2 className="text-4xl sm:text-5xl uppercase font-bold text-gray-900 mt-2 mb-6">
                            Turning Ideas into Connected IoT Products
                        </h2>

                        {/* Paragraph */}
                        <p className="text-gray-700 text-base leading-relaxed mb-4">
                            We transform concepts into fully functional IoT products that deliver efficiency, reliability, and real-time intelligence.

                        </p>
                        <p className="text-gray-700 text-base leading-relaxed mb-8">
                            Our IoT solutions enable businesses to harness the power of connected ecosystems. From smart devices and gateways to cloud platforms and mobile apps, we deliver end-to-end IoT product development. With 5+ years of industry experience, we ensure secure, scalable, and future-ready solutions across industries like manufacturing, healthcare, retail, logistics, and smart cities.
