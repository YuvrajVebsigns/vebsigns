                ...
                <div className="max-w-auto mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
                    ...
                    <div className="relative flex justify-center md:justify-start mt-8 md:mt-12">
                        <img
                            ...
                            className="object-contain w-full max-w-[400px] md:max-w-[700px] h-auto md:h-[610px]"
                        />
                    ...
                    <div className="mt-8 md:mt-0">
                        ...
                        <p className="mt-3 text-sm sm:text-base md:text-lg text-gray-700">
                            Our solutions cover production, deployment, and lifecycle management. Key features include Mass Manufacturing, Device Provisioning, Remote Monitoring & Updates, and Security & Compliance.
