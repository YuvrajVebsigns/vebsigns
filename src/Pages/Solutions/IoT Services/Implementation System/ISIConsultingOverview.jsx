                ...
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-1 md:order-1 w-full">
                        ...
                        <h2 className="text-4xl sm:text-5xl uppercase font-bold text-gray-900 mt-2 mb-6">
                            Connecting IoT Solutions Across Systems
                        </h2>

                        {/* Paragraph */}
                        <p className="text-gray-700 text-base leading-relaxed mb-4">
                            We enable businesses to integrate IoT solutions with their infrastructure, ensuring data flows seamlessly, processes are optimized, and operational efficiency is maximized.

                        </p>
                        <p className="text-gray-700 text-base leading-relaxed mb-8">
                            Our solutions provide end-to-end system integration, including device connectivity, cloud integration, API orchestration, and workflow automation. With 5+ years of experience, we deliver scalable, secure, and industry-aligned integration for sectors like manufacturing, logistics, healthcare, retail, and smart cities.
...
export default ISIConsultingOverview
