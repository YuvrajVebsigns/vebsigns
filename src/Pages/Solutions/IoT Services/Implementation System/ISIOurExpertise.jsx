    ...
    return (
       ...
       <img src="/assets/HomePage/clapping.svg" alt="" className="w-12 h-12 md:w-16 md:h-16" />
                        ...
                        <p className="mt-3 text-sm sm:text-base md:text-lg text-gray-700">
                            Our services ensure smooth IoT deployment and system interoperability. Key features include Device & Platform Deployment, API & System Integration, Workflow Automation, and End-to-End Monitoring.
