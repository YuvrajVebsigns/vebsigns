                ...
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-1 md:order-1 w-full">
                        ...
                        <h2 className="text-4xl sm:text-5xl uppercase font-bold text-gray-900 mt-2 mb-6">
                            Proactive Asset Management with Analytics
                        </h2>

                        {/* Paragraph */}
                        <p className="text-gray-700 text-base leading-relaxed mb-4">
                            We enable organizations to move from reactive to proactive maintenance, minimizing unexpected breakdowns and maximizing operational efficiency.

                        </p>
                        <p className="text-gray-700 text-base leading-relaxed mb-8">
                            Our solutions integrate IoT devices, cloud platforms, and advanced analytics to deliver actionable insights. From equipment monitoring and predictive alerts to trend analysis and reporting, we provide scalable, secure, and industry-aligned solutions for manufacturing, logistics, energy, healthcare, and smart facilities.
...
export default PMAConsultingOverview
