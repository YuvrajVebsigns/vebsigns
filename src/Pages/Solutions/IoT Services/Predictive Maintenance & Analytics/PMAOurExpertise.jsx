    ...
    return (
       ...
       <img src="/assets/HomePage/clapping.svg" alt="" className="w-12 h-12 md:w-16 md:h-16" />
                        ...
                        <p className="mt-3 text-sm sm:text-base md:text-lg text-gray-700">
                            Our solutions focus on monitoring, analyzing, and predicting equipment performance. Key features include Sensor Monitoring, Anomaly Detection, Predictive Modeling, and Real-Time Reporting.
