                ...
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-1 md:order-1 w-full">
                        ...
                        <h2 className="text-4xl sm:text-5xl uppercase font-bold text-gray-900 mt-2 mb-6">
                            Driving IoT Success with Expert Guidance
                        </h2>

                        {/* Paragraph */}
                        <p className="text-gray-700 text-base leading-relaxed mb-4">
                            We provide actionable insights and recommendations to help enterprises make informed decisions, optimize investments, and achieve measurable outcomes in their IoT initiatives.

                        </p>
                        <p className="text-gray-700 text-base leading-relaxed mb-8">
                            Our solutions cover end-to-end advisory support, including technology strategy, ecosystem mapping, ROI analysis, and risk mitigation. With 5+ years of experience, we help industries like manufacturing, healthcare, retail, logistics, and smart cities define strategies that ensure scalable, secure, and impactful IoT adoption.
...
export default SASConsultingOverview
