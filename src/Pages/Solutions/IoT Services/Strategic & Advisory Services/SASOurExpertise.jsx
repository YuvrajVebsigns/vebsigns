        ...
        <div className="max-w-auto mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
          ...
          <div className="mt-8 md:mt-0">
            ...
            <h3 className="font-extrabold uppercase mt-4 text-2xl sm:text-3xl md:text-6xl text-[#15042E]">
              Core Features of Strategic & Advisory Services
            </h3>
            <p className="mt-3 text-sm sm:text-base md:text-lg text-gray-700">
              Our services provide clarity and direction for IoT adoption. Key
              features include IoT Roadmapping, Technology Assessment, Business
              Impact Analysis, and Risk & Compliance Advisory.
            </p>
...
export default SASOurExpertise;
